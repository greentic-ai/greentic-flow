# PR-00-VISION (greentic-flow): Add v0.6 vision docs + Codex rules + deprecation policy
...
## Repo purpose (v0.6)
Flow model + execution semantics; routing, nodes, QA-driven lifecycles, tenant scoping.
